...
export class HeroSection implements OnDestroy {
  ...
  private buildEntranceAnimation(): void {
    ...
    if (reduceMotion) {
      ...
      gsap.set(line1, { autoAlpha: 1, y: 0, filter: 'blur(0px)' });
      return;
    }
    ...
    gsap.set(line1, { autoAlpha: 0, y: 32, filter: 'blur(10px)' });
    ...
    this.ctx = gsap.context(() => {
      ...
      tl.fromTo(line1, {
        ...
        .fromTo(
          ...
          { y: -line2Travel, xPercent: -50, autoAlpha: 1, duration: 1.0 },
          centerReachedAt
        )
        ...
        .fromTo(
          line3,
          { y: line2StartOffscreen, xPercent: -50, autoAlpha: 0 },
          { y: -line3Travel, xPercent: -50, autoAlpha: 1, duration: 1.0 },
          centerReachedAt
        );
